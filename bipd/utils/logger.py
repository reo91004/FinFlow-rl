...
class BIPDLogger:
    ...
    def log_episode(self, episode, reward, portfolio_return, crisis_level, selected_bcell):
        """에피소드 정보 로그"""
        self.info(
            f"에피소드 {episode}: "
            f"보상={reward:.4f}, "
    ...
    def log_system_decision(self, crisis_level, selected_strategy, memory_count, weights):
        """시스템 의사결정 로그"""
