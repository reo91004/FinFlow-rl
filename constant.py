...
BCELL_ACTOR_HIDDEN_SIZE = 256  # 64에서 변경 - 더 큰 네트워크 용량
BCELL_CRITIC_HIDDEN_SIZE = 256  # 64에서 변경 - 더 큰 네트워크 용량
...
# ===== 보상 시스템 (단일 클리핑) =====
REWARD_CLIPPING_RANGE = (-10.0, 10.0)  # (-5.0, 5.0)에서 확대 - 더 큰 학습 신호
