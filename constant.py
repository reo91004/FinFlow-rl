...
INTERMEDIATE_LEARNING_FREQUENCY = 3  # 중간 학습 주기 (core/backtester.py에서 에피소드 중 학습)
...
TOTAL_EPISODES = 5000           # 기본 훈련 총 에피소드 수
CURRICULUM_TOTAL_EPISODES = 10000  # 커리큘럼 학습 총 에피소드 수

# 커리큘럼 학습 레벨별 최소 에피소드 수 (core/curriculum.py)
CURRICULUM_MIN_EPISODES = {
    0: 2000,    # 레벨 0 (안정적 시장): 최소 2000 에피소드
    1: 3000,    # 레벨 1 (중간 변동성): 최소 3000 에피소드  
    2: 5000,    # 레벨 2 (위기 상황): 최소 5000 에피소드
}
